...
struct PreprocOptions {
    ...
    bool        uf_symmetry_breaking = false; // experimental SMT-native QF_UF symmetry breaking over invariant finite-domain values
    ...
    bool        lra_unate_lemmas = false; // experimental: add SAT-visible unate implications between existing simple LRA literals
